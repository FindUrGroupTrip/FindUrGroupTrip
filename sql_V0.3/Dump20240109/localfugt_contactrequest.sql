...
CREATE TABLE `contactrequest` (
  `idcontactrequest` int NOT NULL,
  `subject` varchar(200) DEFAULT NULL,
  `from_email` varchar(45) DEFAULT NULL,
  `message` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`idcontactrequest`)
...
INSERT INTO `contactrequest` VALUES (17483,'faf','danielbet93@gmail.com','afaf'),(37994,'dqdqd','adadad@gmail.com','adad');
